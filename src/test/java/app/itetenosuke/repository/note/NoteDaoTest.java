...
public class NoteDaoTest {
	...
	public void testGetNote() throws Exception {
		...
		assertAll("result",
				() -> assertEquals(Integer.valueOf(0), result.getPainLevel()),
				() -> assertEquals("登録テスト", result.getMemo()),
				() -> assertEquals(expectedMedicine.getMedicineName(), result.getMedicineList().get(0).getMedicineName()));
	}
	...
	public void testCreateNote() throws Exception {
		...
		assertAll("createdNote",
				() -> assertEquals(note.getPainLevel(), createdNote.getPainLevel()),
				() -> assertEquals(note.getMemo(), createdNote.getMemo()),
				() -> assertEquals(parts.getBodyPartsName(), createdNote.getBodyPartsList().get(0).getBodyPartsName()),
				() -> assertEquals(medicine.getMedicineName(), createdNote.getMedicineList().get(0).getMedicineName()),
				() -> assertEquals(medicine.getMedicineSeq(), createdNote.getMedicineList().get(0).getMedicineSeq()),
				() -> assertEquals(parts.getBodyPartsSeq(), createdNote.getBodyPartsList().get(0).getBodyPartsSeq()));
	}
	...
	public void testEditNoteNotAddMedicineAndBodyParts() throws Exception {
		...
		assertAll("editedNote",
				...
				() -> assertEquals(targetNote.getBodyPartsList().get(0).getBodyPartsName(), editedNote.getBodyPartsList().get(0).getBodyPartsName()),
				() -> assertEquals(targetNote.getBodyPartsList().get(0).getBodyPartsSeq(), editedNote.getBodyPartsList().get(0).getBodyPartsSeq()),
				() -> assertEquals(targetNote.getMedicineList().get(0).getMedicineName(), editedNote.getMedicineList().get(0).getMedicineName()),
				() -> assertEquals(targetNote.getMedicineList().get(0).getMedicineSeq(), editedNote.getMedicineList().get(0).getMedicineSeq()));
	}
