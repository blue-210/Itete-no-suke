...
public class MedicineController {
  ...
  @GetMapping("/medicine")
  public String showMedicine(@AuthenticationPrincipal UserDetailsImpl userDetails, Model model) {
  ...
  public String deleteMedicine(@ModelAttribute Medicine medicine,
    ...
    if (result) {
      model.addAttribute("resultMessage",
          message.getMessage("medicine.delete.completed", null, Locale.JAPANESE));
    } else {
      model.addAttribute("resultMessage",
          message.getMessage("medicine.delete.failed", null, Locale.JAPANESE));
    }
  ...
  public String addMedicine(@ModelAttribute @Validated Medicine medicine,
    ...
    if (result) {
      model.addAttribute("resultMessage",
          message.getMessage("medicine.create.completed", null, Locale.JAPANESE));
    } else {
      model.addAttribute("resultMessage",
          message.getMessage("medicine.create.failed", null, Locale.JAPANESE));
    }
