...
public class BodyPartsController {
  ...
  public String deleteBodyParts(@ModelAttribute BodyParts bodyParts,
    ...
    if (result) {
      model.addAttribute("resultMessage",
          message.getMessage("bodyparts.delete.completed", null, Locale.JAPANESE));
    } else {
      model.addAttribute("resultMessage",
          message.getMessage("bodyparts.delete.failed", null, Locale.JAPANESE));
    }
  ...
  public String addBodyParts(@ModelAttribute BodyParts bodyParts,
    ...
    if (result) {
      model.addAttribute("resultMessage",
          message.getMessage("bodyparts.create.completed", null, Locale.JAPANESE));
    } else {
      model.addAttribute("resultMessage",
          message.getMessage("bodyparts.create.failed", null, Locale.JAPANESE));
    }
    return "redirect:/bodyparts";
  }
}
