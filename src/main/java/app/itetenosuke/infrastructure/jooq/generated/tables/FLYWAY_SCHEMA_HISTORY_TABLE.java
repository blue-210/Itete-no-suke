...
import app.itetenosuke.infrastructure.jooq.generated.Indexes;
import app.itetenosuke.infrastructure.jooq.generated.Keys;
import app.itetenosuke.infrastructure.jooq.generated.Sukeroku;
import app.itetenosuke.infrastructure.jooq.generated.tables.records.FlywaySchemaHistoryRecord;
...
public class FLYWAY_SCHEMA_HISTORY_TABLE extends TableImpl<FlywaySchemaHistoryRecord> {

    private static final long serialVersionUID = 1L;

    /**
     * The reference instance of <code>sukeroku.flyway_schema_history</code>
     */
    public static final FLYWAY_SCHEMA_HISTORY_TABLE FLYWAY_SCHEMA_HISTORY = new FLYWAY_SCHEMA_HISTORY_TABLE();
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.installed_rank</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.version</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.description</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.type</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.script</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.checksum</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.installed_by</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.installed_on</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.execution_time</code>.
     */
    ...
    /**
     * The column <code>sukeroku.flyway_schema_history.success</code>.
     */
    ...
    private FLYWAY_SCHEMA_HISTORY_TABLE(Name alias, Table<FlywaySchemaHistoryRecord> aliased) {
        this(alias, aliased, null);
    }

    private FLYWAY_SCHEMA_HISTORY_TABLE(Name alias, Table<FlywaySchemaHistoryRecord> aliased, Field<?>[] parameters) {
        super(alias, null, aliased, parameters, DSL.comment(""), TableOptions.table());
    }

    /**
     * Create an aliased <code>sukeroku.flyway_schema_history</code> table reference
     */
    public FLYWAY_SCHEMA_HISTORY_TABLE(String alias) {
     ...
     * Create an aliased <code>sukeroku.flyway_schema_history</code> table reference
     */
    public FLYWAY_SCHEMA_HISTORY_TABLE(Name alias) {
        this(alias, FLYWAY_SCHEMA_HISTORY);
    }

    /**
     * Create a <code>sukeroku.flyway_schema_history</code> table reference
     */
    public FLYWAY_SCHEMA_HISTORY_TABLE() {
        this(DSL.name("flyway_schema_history"), null);
    }

    public <O extends Record> FLYWAY_SCHEMA_HISTORY_TABLE(Table<O> child, ForeignKey<O, FlywaySchemaHistoryRecord> key) {
    ...
    @Override
    public FLYWAY_SCHEMA_HISTORY_TABLE as(String alias) {
        return new FLYWAY_SCHEMA_HISTORY_TABLE(DSL.name(alias), this);
    }

    @Override
    public FLYWAY_SCHEMA_HISTORY_TABLE as(Name alias) {
        return new FLYWAY_SCHEMA_HISTORY_TABLE(alias, this);
    }
     ...
     */
    @Override
    public FLYWAY_SCHEMA_HISTORY_TABLE rename(String name) {
        return new FLYWAY_SCHEMA_HISTORY_TABLE(DSL.name(name), null);
    }
     ...
     */
    @Override
    public FLYWAY_SCHEMA_HISTORY_TABLE rename(Name name) {
        return new FLYWAY_SCHEMA_HISTORY_TABLE(name, null);
    }
