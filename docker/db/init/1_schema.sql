...
ADD FOREIGN KEY (fk_images_id) REFERENCES images (images_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE users_bodyparts
ADD FOREIGN KEY (fk_body_parts_id) REFERENCES bodyparts (body_parts_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE notes_bodyparts
ADD FOREIGN KEY (fk_bodyparts_id) REFERENCES bodyparts (body_parts_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE notes_medicine
ADD FOREIGN KEY (fk_medicine_id) REFERENCES medicine (medicine_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE users_medicine
ADD FOREIGN KEY (fk_medicine_id) REFERENCES medicine (medicine_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE notes_images
ADD FOREIGN KEY (fk_note_id) REFERENCES notes (note_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE notes_bodyparts
ADD FOREIGN KEY (fk_note_id) REFERENCES notes (note_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE notes_medicine
ADD FOREIGN KEY (fk_note_id) REFERENCES notes (note_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE users_notes
ADD CONSTRAINT users_notes_fk_note_id_fkey FOREIGN KEY (fk_note_id) REFERENCES notes (note_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
ALTER TABLE users_bodyparts
ADD FOREIGN KEY (fk_user_id) REFERENCES users (user_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE users_medicine
ADD FOREIGN KEY (fk_user_id) REFERENCES users (user_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
ALTER TABLE users_notes
ADD CONSTRAINT users_notes_fk_user_id_fkey FOREIGN KEY (fk_user_id) REFERENCES users (user_id) ON UPDATE NO ACTION ON DELETE NO ACTION;
/* Comments */
